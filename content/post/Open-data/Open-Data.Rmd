...
Voici un exemple d'exploration des données de la Banque Mondiale en utilisant le pakage R "wbstats" qui permet d'utiliser facilement l'API associée.
...
```{r echo=FALSE}
knitr::include_url("http://umap.openstreetmap.fr/fr/map/odservatoire_256503#6/45.813/5.603")
```

> Ceyye carte interactive des acteurs de l'open data territorial est produite par [l'observatoire de l'open data des territoires](http://www.observatoire-opendata.fr/)
...
<img src="/img/lost_image.png" alt="Kitten"
	title="Lost with open data" width="100%"  />
